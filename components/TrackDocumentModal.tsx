...
export const TrackDocumentModal: React.FC<TrackDocumentModalProps> = ({ isOpen, onClose, onManualSubmit }) => {
  ...
  return (
    <div 
      ...
      aria-modal="true"
    >
      <div className="bg-white/30 dark:bg-slate-800/50 backdrop-blur-xl p-6 rounded-2xl shadow-xl w-full max-w-md border border-white/30 dark:border-slate-700/30">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100" id="track-modal-title">
            Track a Document
          </h3>
          <button onClick={handleClose} className="p-1 rounded-full text-slate-500 hover:bg-slate-200/50 dark:text-slate-400 dark:hover:bg-slate-700/50">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="block w-full px-3 py-2 bg-white/40 dark:bg-slate-700/50 border border-white/30 dark:border-slate-600/50 rounded-md text-sm shadow-sm placeholder-slate-500 dark:text-slate-300 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500"
              />
              <button 
                type="submit"
                className="px-6 py-2 text-sm font-medium text-white bg-sky-600 rounded-md shadow-lg hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 disabled:bg-slate-400"
