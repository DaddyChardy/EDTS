...
export const LoginPage: React.FC<LoginPageProps> = ({ onLogin, users }) => {
  ...
  return (
    <main className="w-full h-screen flex items-center justify-center bg-slate-100 dark:bg-slate-950 p-4">
        <div className="w-full max-w-md">
            <div className="text-center mb-8">
                <img src="https://images.seeklogo.com/logo-png/35/1/department-of-agrarian-reform-logo-png_seeklogo-354283.png" alt="DAR Logo" className="h-24 w-24 mx-auto mb-4" />
                <h1 className="text-3xl font-bold text-slate-900 dark:text-white">DAR EDTS</h1>
                <p className="text-md text-slate-500 dark:text-slate-400 mt-1">Enterprise Document Tracking System</p>
            </div>
            
            <div className="bg-white dark:bg-slate-900/50 p-8 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-800">
                ...
                <div>
                    ...
                    <select
                      ...
                      className="mt-1 block w-full px-4 py-3 text-base border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500 rounded-xl"
                    >
